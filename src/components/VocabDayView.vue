<template>
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 sm:p-4 z-50"
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
            <!-- Header -->
            <div
                class="sticky top-0 bg-white border-b border-gray-200 p-4 sm:p-6 flex justify-between items-start z-10">
            ...
            <div class="p-4 sm:p-6 space-y-3 sm:space-y-4">
                <div v-for="(word, index) in filteredWords" :key="index"
                    ...
                    <div class="flex items-start gap-3 sm:gap-4">
                        <!-- Number Badge -->
                        <span
                            class="bg-blue-600 text-white w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-bold text-sm sm:text-base flex-shrink-0">
                            {{ index + 1 }}
                        </span>
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <button @click="speakWord(word.english)"
