<template>
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h3 class="text-xl font-bold text-gray-800 mb-6">Weekly Progress</h3>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <!-- Week 1 -->
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <h4 class="text-sm font-semibold text-gray-700">Week 1</h4>
                        <span class="text-xs text-gray-500">Days 1-7</span>
                    </div>
                    <div class="space-y-1">
                        <div v-for="day in 7" :key="day" :class="[
                            ...
                            <span>Day {{ day }}</span>
                            <span v-if="completedDays.includes(day)" class="ml-1">✓</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <h4 class="text-sm font-semibold text-gray-700">Week 2</h4>
                        <span class="text-xs text-gray-500">Days 8-14</span>
                    </div>
                    <div class="space-y-1">
                        <div v-for="day in [8, 9, 10, 11, 12, 13, 14]" :key="day" :class="[
                            'h-8 rounded-lg flex items-center justify-center text-xs font-medium transition-all',
                            completedDays.includes(day)
                                ? 'bg-green-500 text-white'
                                : currentDay > day
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <h4 class="text-sm font-semibold text-gray-700">Week 3</h4>
                        <span class="text-xs text-gray-500">Days 15-21</span>
                    </div>
                    <div class="space-y-1">
                        <div v-for="day in [15, 16, 17, 18, 19, 20, 21]" :key="day" :class="[
                            'h-8 rounded-lg flex items-center justify-center text-xs font-medium transition-all',
                            completedDays.includes(day)
                                ? 'bg-green-500 text-white'
                                : currentDay > day
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <h4 class="text-sm font-semibold text-gray-700">Week 4</h4>
                        <span class="text-xs text-gray-500">Days 22-30</span>
                    </div>
                    <div class="space-y-1">
                        <div v-for="day in [22, 23, 24, 25, 26, 27, 28, 29, 30]" :key="day" :class="[
                            'h-8 rounded-lg flex items-center justify-center text-xs font-medium transition-all',
                            completedDays.includes(day)
                                ? 'bg-green-500 text-white'
                                : currentDay > day
