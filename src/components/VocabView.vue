<template>
  <div>
    <div class="mb-6 sm:mb-8">
      ...
      <p class="text-sm sm:text-base text-gray-600">Learn 50 new words every day. Complete tests every 3 days to unlock more!</p>
    </div>
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-sm text-yellow-700 mb-3">
            You need to pass the test for Days {{ lastTestDay + 1 }}-{{ lastTestDay + 3 }} to unlock Day {{ lastTestDay + 4 }}.
          </p>
    ...
    <div class="relative">
      <!-- Timeline Line -->
      <div class="absolute left-6 sm:left-10 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-200 via-purple-200 to-pink-200"></div>
      ...
      <div class="space-y-4 sm:space-y-6">
        ...
        >
          ...
          >
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 mb-1">
                  ...
                  <span v-if="day === currentDay" class="bg-blue-500 text-white text-xs px-2 py-0.5 rounded-full">
                    Current
                  </span>
                </div>
            ...
            <div v-if="day === currentDay && !completedDays.includes(day)" class="mt-3 pt-3 border-t border-blue-200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl border border-blue-200">
            ...
            <div class="text-xs text-blue-600 mt-1">
              {{ completedDays.filter(d => d <= 7).length }}/7 completed
            </div>
          </div>
          <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-xl border border-purple-200">
            ...
            <div class="text-xs text-purple-600 mt-1">
              {{ completedDays.filter(d => d > 7 && d <= 21).length }}/14 completed
            </div>
          </div>
